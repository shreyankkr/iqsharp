...
namespace Tests.IQSharp
{
    ...
    public class NugetPackagesTests
    {
        ...
        public static readonly NuGetVersion QDK_LIBRARIES_VERSION = NuGetVersion.Parse("0.10.2001.2831");
        ...
        public async Task FindDependencies()
        {
            ...
            using (var context = new SourceCacheContext())
            {
                ...
                Assert.AreEqual(137, dependencies.Count());
            }
        }
        ...
        public async Task GetPackageDependencies()
        {
            ...
            using (var context = new SourceCacheContext())
            {
                ...
                Assert.AreEqual(100, dependencies.Count());
            }
        }
